...
# Example usage
input_pdf = '/media/cle-nb-183/New Volume/CLE/1.pdf files/Darbar-e-Akbari.pdf'  # Path to your input PDF
output_pdf = 'Short_Darbar-e-Akbari.pdf.pdf'  # Path for the output PDF
start_page = 10  # Starting page (1-indexed)
end_page = 13    # Ending page
