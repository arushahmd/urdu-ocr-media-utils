import csv
from common import count_files_in_channels, channels
...
if __name__ == "__main__":
    train_images_dir = 'balanced-image-dataset/train/images'
    train_annotations_dir = 'balanced-image-dataset/train/annotations_urdu'
    test_images_dir = 'balanced-image-dataset/test/images'
    test_annotations_dir = 'balanced-image-dataset/test/annotations_urdu'
    ...
    csv_train_path = ('/results/channel_stats_train_exp_bal.csv')
    csv_test_path = ('results/channel_stats_test_exp_bal.csv')

    csv_total_path = ('/results/channel_stats_total_exp_bal.csv')
