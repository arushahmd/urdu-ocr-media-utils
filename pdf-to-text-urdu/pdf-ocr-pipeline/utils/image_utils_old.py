...
# binairized image means turn the Gray image into the numbers from 0(white) to 255(black) w.r.t the image pixels intensity
def _binarize(image, blur=True):
    ...
    from  utils.binarization import get_gray_image, convert_binary
